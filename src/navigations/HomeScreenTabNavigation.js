...
import { FONT_FAMILY_LIGHT, MAIN_COLOR } from "../constant";
		...
		return (
			...
			>
				<Tab.Screen
					...
					options={{
						tabBarIcon: ({ focused }) => {
							return <Icon name="home" type="font-awesome" size={20} color={focused ? MAIN_COLOR : "#fff"} />;
						},
						tabBarLabel: ({ focused }) => {
							return (
								<Text
				...
				<Tab.Screen
					...
					options={{
						tabBarIcon: ({ focused }) => {
							return <Icon name="newspaper" type="ionicon" size={20} color={focused ? MAIN_COLOR : "#fff"} />;
						},
						tabBarLabel: ({ focused }) => {
							return (
								<Text
				...
				<Tab.Screen
					...
					options={{
						tabBarIcon: ({ focused }) => {
							return <Icon name="user" type="font-awesome" size={20} color={focused ? MAIN_COLOR : "#fff"} />;
						},
						tabBarLabel: ({ focused }) => {
							return (
								<Text
